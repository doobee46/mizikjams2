...
var AsyncVideos;
(function (AsyncVideos) {
    var Grid = (function () {
        function Grid(formContainer, container, emptyContainer, loader, apiEndpoint) {
        ...
        Grid.prototype.loaded = function () {
            this.loader.hide();
        };
        Grid.prototype.initCurrentForm = function () {
            this.currentForm = new AsyncVideos.Form(this.formContainer.find('form'), this);
        };
        Grid.prototype.requestData = function () {
            this.loading();
            $.ajax({
        ...
        Grid.prototype.verifyRecords = function () {
        ...
        Grid.prototype.processData = function (response) {
            var _self = this;
            response.forEach(function (remoteVideo) { return _self.processRecord(remoteVideo); });
            this.verifyRecords();
        };
        Grid.prototype.processRecord = function (remoteVideo) {
            var record = new Record(this);
            this.container.find('tbody').append(record.container);
            record.setModel(remoteVideo);
            this.records.push(record);
        };
        Grid.prototype.appendRecord = function (record) {
            this.container.find('tbody').append(record.container);
            this.refreshForm();
        ...
        Grid.prototype.onRemoveSuccess = function (record) {
        ...
        Grid.prototype.removeRecord = function (record) {
            var _this = this;
            var deleteURL = this.apiEndpoint + '/' + record.remoteVideo.remote_id;
            this.loading();
            $.ajax({
                url: deleteURL,
                type: 'DELETE',
                complete: this.loaded,
                success: function () {
                    _this.onRemoveSuccess(record);
                },
                context: this
            });
        };
        Grid.prototype.refreshForm = function () {
    ...
    AsyncVideos.Grid = Grid;
    var Record = (function () {
        function Record(grid) {
            this.grid = grid;
        ...
        Record.prototype.setModel = function (remoteVideo) {
        ...
        Record.prototype.updateProgressBar = function (value) {
            var _self;
        ...
        Record.prototype.setVideoPlayer = function (remoteVideoURL) {
            var _self = this;
            var videoPlayer = $('<video/>', { 'controls': true, 'width': "320", 'height': "240", 'class': 'video-player' });
            ...
            if (this.remoteVideo.remote_id != null)
                this.initDestroyButton();
        };
        Record.prototype.initDestroyButton = function () {
            var _self = this;
            ...
            button.click(function () { return _self.remove(); });
        };
        Record.prototype.remove = function () {
            this.grid.removeRecord(this);
        };
        Record.prototype.initProgressBar = function () {
        ...
        Record.prototype.initContainer = function () {
            this.container = $('<tr/>');
    ...
    AsyncVideos.Record = Record;
    var PreviewVideo = (function () {
        function PreviewVideo(container, form) {
            this.container = container;
            this.form = form;
            this.initContainer();
        }
        PreviewVideo.prototype.setVideo = function (data) {
        ...
        PreviewVideo.prototype.initContainer = function () {
            var _self = this;
            ...
            this.removeButton.click(function () { return _self.onRemove(); });
            this.container.hide();
        };
        PreviewVideo.prototype.onRemove = function () {
    ...
    AsyncVideos.PreviewVideo = PreviewVideo;
    var Form = (function () {
        function Form(container, grid) {
            this.container = container;
            this.grid = grid;
            this.fileData = null;
        ...
        Form.prototype.clearFileInput = function () {
            this.container.find('.upload-button input').val('');
        };
        Form.prototype.initPreviewVideo = function () {
            this.previewVideo = new PreviewVideo(this.container.find('.file-data'), this);
        };
        Form.prototype.initFileUpload = function () {
            var _self = this;
            this.container.fileupload({
                ...
                progressall: function (e, data) {
                    ...
                    setTimeout(function () { return _self.receiveModel(data.result); }, 1000);
                }
            });
            this.container.submit(function (e) { return _self.serializeForm(e); });
        };
        Form.prototype.receiveModel = function (remoteVideo) {
            if (this.keepPreviewURL) {
                remoteVideo.original_url = remoteVideo.remote_video_url;
                remoteVideo.remote_video_url = this.previewVideo.videoPlayer.attr('src');
            }
        ...
        Form.prototype.initFormValidation = function () {
            this.container.form({
                fields: {
                    name: {
        ...
        Form.prototype.serializeForm = function (e) {
            var _self = this;
            var data = null;
            var objects = null;
            e.preventDefault();
        ...
        Form.id = 0;
        Form.acceptedFormats = /(\.|\/)(asf|avi|flv|m4v|mov|mp4|mp4a|m4a|3g2|mj2|wmv|mp3)$/i;
        return Form;
    })();
    AsyncVideos.Form = Form;
})(AsyncVideos || (AsyncVideos = {}));
var AsyncVideos;
(function (AsyncVideos) {
    var Sync = (function () {
        function Sync(button, apiEndpoint) {
            this.button = button;
            this.apiEndpoint = apiEndpoint;
            this.initContainer();
        }
        Sync.prototype.loading = function () {
            this.button.addClass('loading');
        };
        Sync.prototype.loaded = function () {
            this.button.removeClass('loading');
        };
        Sync.prototype.initContainer = function () {
            var _self = this;
            this.button.click(function () { return _self.doRequest(); });
        };
        Sync.prototype.doRequest = function () {
            this.loading();
            $.ajax({
                url: this.apiEndpoint,
        ...
        Sync.prototype.onSuccess = function () {
            $('#sync-success').modal('show');
        };
        return Sync;
    })();
    AsyncVideos.Sync = Sync;
})(AsyncVideos || (AsyncVideos = {}));
